...
- [ ] 10.4 实现文件哈希计算 (可选)
- [x] 10.5 实现缓存命中标记
- [x] 10.6 编写 MetadataBuilder 单元测试
...
- [x] 12.1 使用 a.md 中的 URL 创建测试 fixtures
- [x] 12.2 模拟 HTTP 服务器 (Nock/MSW)
- [x] 12.3 测试完整下载流程 (未命中缓存)
- [x] 12.4 测试缓存命中流程 (相同路径)
- [x] 12.5 测试缓存命中流程 (不同路径 → 复制)
- [ ] 12.6 测试失败重试流程
- [ ] 12.7 测试并发限制和节流
- [ ] 12.8 测试崩溃恢复
- [ ] 12.9 测试 429 限速响应
...
- [x] 13.1 创建 FileServerHandler (src/js/handler/file-server.js)
- [x] 13.2 实现批量任务提交逻辑
- [x] 13.3 实现轮询查询逻辑
- [ ] 13.4 实现 SSE 连接逻辑 (可选)
- [x] 13.5 实现结果应用 (URL → 相对路径替换)
- [x] 13.6 实现错误处理和重试
- [x] 13.7 集成到 backend.js

## 14. 配置与 UI

- [x] 14.1 在 config.js 中添加 File Server 配置项
- [x] 14.2 在 setting.html 中添加 File Server 设置面板
- [x] 14.3 实现 Token 配置输入
- [x] 14.4 实现白名单 profile 选择
- [x] 14.5 实现连接测试按钮
- [x] 14.6 实现启用/禁用开关

## 15. 文档编写

- [x] 15.1 编写 file-server/README.md (服务器使用文档)
- [x] 15.2 编写 API 文档
- [ ] 15.3 编写插件集成指南
- [x] 15.4 编写配置示例
- [x] 15.5 编写故障排查指南
...
- [x] 16.1 启动 File Server 进程
- [x] 16.2 配置插件连接 File Server
- [x] 16.3 执行完整剪辑流程
- [x] 16.4 验证文件正确保存
- [x] 16.5 验证缓存复用
- [x] 16.6 验证相对路径正确
